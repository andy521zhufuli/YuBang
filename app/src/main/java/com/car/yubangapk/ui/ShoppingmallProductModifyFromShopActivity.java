...
public class ShoppingmallProductModifyFromShopActivity extends BaseActivity implements View.OnClickListener {


    private Context mContext;
    private static final String TAG = ShoppingmallProductModifyFromShopActivity.class.getName();
