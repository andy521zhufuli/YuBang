...
public class DiscoverNearbyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private final static String TAG = "DiscoverNearbyActivity";
    ...
    private void initMapDataList() {
        ...
        bdMapClientList.add(new BDMapData("保利汽修", latitude + 0.024, longitude - 0.0105));
        bdMapClientList.add(new BDMapData("中海汽修", latitude - 0.00052, longitude - 0.01086));
        bdMapClientList.add(new BDMapData("高德汇", latitude + 0.0124, longitude + 0.00184));
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.image1:
                ...
                intent.setClass(DiscoverNearbyActivity.this, FirstPageShopShowActivity.class);
            ...
            case R.id.image2:
                ...
                intent1.setClass(DiscoverNearbyActivity.this, FirstPageShopShowActivity.class);
            ...
            case R.id.image3:
                ...
                intent2.setClass(DiscoverNearbyActivity.this, FirstPageShopShowActivity.class);
