...
public class Validator {
     ...
     * 正则表达式：验证手机号
     */
    public static final String REGEX_MOBILE1 = "^((13[0-9])|(15[^4,\\D])|(18[0,5-9]))\\d{8}$";
     ...
     * 正则表达式：验证  验证码
     */
    public static final String REGEX_IP_ERIFY_CODE = "^[0-9]{4}$";
    ...
    {
        return Pattern.matches(REGEX_IP_ERIFY_CODE, code);
    }
