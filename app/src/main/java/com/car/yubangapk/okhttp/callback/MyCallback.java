...
public abstract class MyCallback<T>
{
    ...
    public abstract void onError(Call call, int position,Exception e);

    public abstract void onResponse(T response, int position);
    ...
    public static MyCallback CALLBACK_DEFAULT = new MyCallback()
    {
        ...
        @Override
        public void onResponse(Object response, int position)
        {
