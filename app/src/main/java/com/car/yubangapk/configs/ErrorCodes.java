...
public class ErrorCodes {
    ...
    public static final int ERROR_CODE_UPLOAD_USER_PIC_PARAM_ERROR = -1;//参数错误
    public static final int ERROR_CODE_PARAM_ERROR = -2;//参数错误
    public static final int ERROR_CODE_USER_NOT_EXAIT = -3;//用户不存在
    public static final int ERROR_CODE_USER_VERIFY_CODE_SEND_FIAL = -7;//验证码发送失败
    public static final int ERROR_CODE_USER_OLD_PWD_ERROR = -4;//原始密码错误
    public static final int ERROR_CODE_USER_PHONE_NUM_EXISTED = -5;//手机号码已存在
    public static final int ERROR_CODE_USER_PHONE_VERIFY_CODE_EREROR = -6;//验证码错误
    public static final int ERROR_CODE_FILE_NOT_EXIT = 1234;//上传照片  图片不存在
