...
import com.car.yubangapk.model.Character;
import com.car.yubangapk.model.Section;
...
public class SectionAdapter extends BaseGroupAdapter<Section, Character> {
    ...
    public int getChildCount(int groupPosition) {
        List<com.car.yubangapk.model.Character> characters = getGroup(groupPosition).getCharacters();
