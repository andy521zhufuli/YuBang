...
//    ]
    ...
    private String usefullServiceName;//两个字的服务名称

    public String getUsefullServiceName() {
        return usefullServiceName;
    }

    public void setUsefullServiceName(String usefullServiceName) {
        this.usefullServiceName = usefullServiceName;
    }
