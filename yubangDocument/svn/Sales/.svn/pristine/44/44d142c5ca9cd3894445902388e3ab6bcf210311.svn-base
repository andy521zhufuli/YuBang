...
public class TOrderDAO extends HibernateDaoSupport {
	...
	public List<TOrder> findByExample(TOrder instance) {
		...
		try {
			List<TOrder> results = (List<TOrder>) getHibernateTemplate()
	...
	public List<TOrder> findByStatus(Object status) {
	...
	public List<TOrder> findByGoodslist(Object goodslist) {
		return findByProperty(GOODSLIST, goodslist);
	}

	public List<TOrder> findByAddressname(Object addressname) {
		return findByProperty(ADDRESSNAME, addressname);
	}

	public List<TOrder> findByAddressphone(Object addressphone) {
		return findByProperty(ADDRESSPHONE, addressphone);
	}

	public List<TOrder> findByAddress(Object address) {
		return findByProperty(ADDRESS, address);
	}

	public List<TOrder> findByValue(Object value) {
