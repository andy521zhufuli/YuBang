...
public class AuthSSLProtocolSocketFactory implements SecureProtocolSocketFactory {
    ...
    public AuthSSLProtocolSocketFactory(
        final String keystoreUrl, final String keystorePassword, 
        final String truststoreUrl, final String truststorePassword)
    {
        super();
    ...
    private static KeyStore createKeyStore(final String url, final String password, String storeType) 
    ...
    private SSLContext createSSLContext() {
        try {
            ...
            if (this.keystoreUrl != null) {
                KeyStore keystore = createKeyStore(this.keystoreUrl, this.keystorePassword, "PKCS12");
