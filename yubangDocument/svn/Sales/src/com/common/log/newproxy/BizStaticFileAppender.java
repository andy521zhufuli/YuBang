    ...
    extends TimeSizeRollingFileAppender  implements ErrorCode
{
    ...
    /**
     * 为锟斤拷锟斤拷锟斤拷锟街拘э拷剩锟街伙拷锟�锟斤拷前锟斤拷指锟斤拷锟斤拷时锟斤拷锟斤拷锟斤拷锟揭碉拷锟斤拷锟街撅拷锟斤拷锟斤拷
     * 锟斤拷锟斤拷为锟斤拷位
     */
    private int ts_offset;
    /**
     * 锟斤拷识锟斤拷一锟斤拷越锟斤拷一锟斤拷
     * 缺省锟斤拷true,锟皆憋拷系统锟斤拷前一锟斤拷停止锟斤拷锟节讹拷锟斤拷锟斤拷锟斤拷锟斤拷时也锟斤拷执锟叫凤拷锟斤拷锟斤拷锟斤拷锟侥硷拷
     * 锟斤拷使锟截革拷锟斤拷锟斤拷锟斤拷也锟斤拷锟斤拷锟截革拷锟斤拷锟斤拷
     */
    ...
    /**
     * 锟较回比较的碉拷前时锟斤拷锟斤拷锟斤拷时锟斤拷牟锟�
     * 锟斤拷值锟斤拷一锟斤拷锟节从ｏ拷锟斤拷锟斤拷锟斤拷锟斤拷
     */
//    private long last_ts_trap;
    /**
     * 锟斤拷一锟斤拷锟斤拷锟叫达拷锟斤拷锟街撅拷募锟角白猴拷锟�
     * 只锟斤拷锟斤拷锟节ｏ拷锟斤拷锟斤拷.n.bak,锟斤拷Pullbiz.log2005-09-14-23
     */
    private String lastLogFilePrefix;
    /**
     * 锟斤拷一锟斤拷锟斤拷锟叫达拷锟斤拷锟街撅拷募锟斤拷挚锟斤拷锟斤拷
     * 锟斤拷锟睫ｏ拷锟斤拷为0;
     */
    ...
    private void publishOldCheckFile()
    {
        ...
        for(int i=0;i<checkFiles.length;i++)
        {
            ...
            {//锟斤拷锟斤拷潜锟斤拷锟揭碉拷锟斤拷锟街撅拷募锟斤拷锟斤拷锟斤拷锟斤拷
                continue;
            }
            if (tmpfileName.endsWith(".bak"))
            {//锟斤拷锟斤拷一锟斤拷未锟斤拷锟斤拷锟斤拷锟斤拷募锟斤拷锟斤拷锟斤拷锟斤拷锟街撅拷募锟斤拷锟斤拷锟揭拷拥锟斤拷锟接︼拷亩锟斤拷锟斤拷募锟斤拷锟�
            ...
            {//锟斤拷锟斤拷一锟斤拷未锟斤拷锟斤拷锟侥讹拷锟斤拷锟侥硷拷锟斤拷锟斤拷要锟斤拷锟斤拷
                int index=fileName.lastIndexOf(FILE_SEP);
                //锟矫碉拷去锟斤拷路锟斤拷锟斤拷锟侥硷拷锟斤拷锟斤拷锟斤拷
                String bizName=fileName.substring(index+1);
        ...
        {//锟斤拷苑锟斤拷值锟矫恳伙拷锟轿达拷锟斤拷锟斤拷亩锟斤拷锟斤拷募锟�
            ...
            {//锟斤拷一锟斤拷未锟斤拷锟斤拷锟侥讹拷锟斤拷锟侥硷拷
                ...
                try
                {
                    ...
                    { //一锟斤拷未锟斤拷锟斤拷锟斤拷锟斤拷募锟斤拷锟斤拷锟斤拷锟斤拷锟街撅拷募锟�
...
/*        if (lastDayTime<currDate)
        {//某锟斤拷锟斤拷锟斤拷映锟斤拷诤锟侥碉拷一锟斤拷锟斤拷志锟斤拷锟斤拷要锟结供锟斤拷锟斤拷锟侥硷拷锟斤拷锟斤拷锟斤拷锟侥硷拷
            if (first_on_day)
            {//锟斤拷一锟斤拷越锟斤拷一锟斤拷
                first_on_day = false;
                //锟斤拷锟斤拷前一锟斤拷亩锟斤拷锟斤拷募锟�
//                publishCheckFile();

                //删锟斤拷锟窖撅拷锟斤拷锟竭的伙拷锟斤拷锟侥硷拷
                //statFile.delete();
            }
        }*/
//        last_ts_trap=ts_trap;
    ...
    {
            /*
            锟斤拷为锟斤拷锟斤拷志锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷时锟斤拷锟街笆憋拷锟斤拷锟斤拷位锟矫碉拷锟叫讹拷锟角诧拷准锟侥ｏ拷锟斤拷取锟斤拷私涌锟�
            if(ts_start > 0)
            {//锟叫达拷锟斤拷锟斤拷指锟斤拷要锟斤拷锟斤拷时锟斤拷锟�
                ...
                { //锟斤拷前系统时锟斤拷锟揭碉拷锟斤拷锟街臼憋拷锟襟，硷拷锟斤拷锟斤拷锟剿第讹拷锟斤拷,锟斤拷锟斤拷志锟斤拷锟角记碉拷前一锟斤拷
            ...
            */if(msg instanceof BizLogContent)
            { //锟斤拷通锟斤拷锟斤拷锟斤拷锟斤拷冉锟斤拷欠锟叫达拷锟斤拷锟揭伙拷募锟�
                long bizTsDate = ((BizLogContent)msg).getTimestamp();
                if(bizTsDate > 0)
                { //锟叫革拷值锟斤拷锟叫比斤拷
                    if(currDate > bizTsDate)
                    { //锟斤拷前系统时锟斤拷锟揭碉拷锟斤拷锟街臼憋拷锟襟，硷拷锟斤拷锟斤拷锟剿第讹拷锟斤拷
                        //lastDay.append(bizTsDate);
                        return true;
                    }
                }
    ...
    private boolean log2extraFile(LoggingEvent event)
    {
        ...
        if (inCheckTrap() && event!=null)
        {
	        ...
	        if (needAppendExtra)
	        {//锟节硷拷锟绞憋拷锟轿ｏ拷锟斤拷锟斤拷业锟斤拷时锟斤拷锟叫★拷诘锟角跋低呈憋拷锟�写锟斤拷锟斤拷锟斤拷锟侥硷拷
	            String statPath=LogHelper.getLogRootPath()+FILE_SEP+"log"+FILE_SEP
	                            +CHECKFILE_PATH+FILE_SEP;
	            File path=new File(statPath);
	            if (!path.exists())
    ...
    private long getCurrDate()
    {
        //取锟矫碉拷锟斤拷锟斤拷锟斤拷锟�
            ...
            {//锟斤拷锟角帮拷锟斤拷锟斤拷锟较次硷拷锟斤拷锟斤拷锟揭拷锟剿碉拷锟斤拷锟斤拷锟斤拷碌锟揭伙拷锟�
                first_on_day=true;
            }
            return currDate;
    }
    ...
    public void subAppend(LoggingEvent event)
    {
        ...
        {//没锟斤拷写锟斤拷锟斤拷锟斤拷锟斤拷志锟斤拷锟斤拷写锟斤拷锟斤拷志锟斤拷锟斤拷锟斤拷锟叫达拷锟�
        	if(event!=null){
     ...
     * @param pFileName String实锟绞碉拷锟侥硷拷锟斤拷
     * @param typeName String锟侥硷拷锟斤拷锟斤拷锟斤拷
     * @param pattern String锟侥硷拷锟斤拷锟叫碉拷锟斤拷锟节革拷式
     ...
     * @param fileDate 锟侥硷拷锟斤拷锟斤拷锟斤拷薷锟绞憋拷锟�
     * @return boolean
     */
    private boolean isCheckReportPublished(long fileDate)
    {
        ...
        { //锟斤拷锟斤拷锟侥硷拷锟窖凤拷锟斤拷锟斤拷锟酵诧拷锟斤拷写锟斤拷锟斤拷锟侥硷拷锟斤拷
            return true;
        }
        return false;
    }
    ...
    private void logStastics(String logFileName,String seq)
    {
        ...
        try
        {
            ...
            {//锟斤拷锟秸的讹拷锟斤拷锟侥硷拷锟窖凤拷锟斤拷锟斤拷logCheck.sh锟斤拷锟斤拷锟斤拷,锟酵诧拷锟截革拷锟斤拷锟斤拷
                return;
            }*/
            FileWriter fw=null;
            if (statFile.exists())
...
LogLog.debug("isCheckReportPublished(currFileDate):"+isCheckReportPublished(currFileDate));
        ...
        {//锟斤拷锟侥硷拷锟斤拷锟节讹拷应锟侥讹拷锟斤拷锟侥硷拷锟窖凤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷募锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷志锟侥硷拷
            currFile.delete();
            for(int i=1;i<=maxBackupIndex;i++)
            {//锟斤拷然currFile锟窖撅拷锟斤拷锟节ｏ拷锟斤拷锟斤拷锟斤拷xx.log.1,xxxlog.2锟斤拷锟斤拷锟斤拷
...
LogLog.debug("file.renameTo(target) result:"+result);
	...
	// 锟睫革拷锟斤拷pps_common锟斤拷log锟斤拷锟斤拷锟絝ileCopy锟斤拷锟斤拷
