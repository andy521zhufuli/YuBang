...
public class CopyOfMyHorizontalScrollView1 extends HorizontalScrollView implements
		OnClickListener
{
	...
	public CopyOfMyHorizontalScrollView1(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		// 获得屏幕宽度
