...
import com.tec.android.ui.ConformOrderActivity;
import com.tec.android.ui.IWantGetCashAccountActivity;
import com.tec.android.ui.IWantGetCashHowMoneyActivity;
import com.tec.android.ui.LoginActivity;
import com.tec.android.ui.MyCashActivity;
import com.tec.android.ui.MyCashDetailInfoActivity;
import com.tec.android.ui.MyCashListActivity;
import com.tec.android.ui.MyFriendPersonalCenterActivity;
import com.tec.android.ui.MyFriendsActivity;
import com.tec.android.ui.MyIncomeActivity;
import com.tec.android.ui.MyInfoActivity;
import com.tec.android.ui.MyOrderActivity;
import com.tec.android.ui.OrderDetailActivity;
import com.tec.android.ui.ReceivingAddressListActivity;
...
public class AccountInfoJs
{
    ...
    public void MyOrder()
    {
        toastMgr.builder.display("js-->native, MyOrder", 0);
    ...
    public void MyCash()
    {
        ...
        Intent intent = new Intent();
        intent.setClass(mContext, MyCashActivity.class);
        mContext.startActivity(intent);
    }
    ...
    public void CashOut()
    {
        toastMgr.builder.display("js-->native, MyCash", 0);
        Intent intent = new Intent();
        intent.setClass(mContext, IWantGetCashHowMoneyActivity.class);
        mContext.startActivity(intent);
    }
    ...
    public void MyCashList()
    {
        //我的提现记录 历史
        Intent intent = new Intent();
        intent.setClass(mContext, MyCashListActivity.class);
        mContext.startActivity(intent);
    }
    ...
    public void CashDetail(String cashid)
    {
        ...
        Intent intent = new Intent();
        intent.setClass(mContext, MyCashDetailInfoActivity.class);
...
//        toastMgr.builder.display("js-->native, MyFriends", 0);
        Intent intent = new Intent();
        intent.setClass(mContext, MyFriendsActivity.class);
    ...
    public void MyFriendInfo(String fuserid)
    {
        //打开我的朋友的个人中心
        Intent intent = new Intent();
        intent.setClass(mContext, MyFriendPersonalCenterActivity.class);
        intent.putExtra("fuserid",fuserid);
        mContext.startActivity(intent);
    }
    ...
    {
        //判断是否登陆
        String isLogined = SPUtils.getUserInfo(mContext, Configs.IS_USER_LOGINED, Configs.NOT_LOGINED);
