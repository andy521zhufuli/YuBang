 ...
 * 我的好友的好友列表
 */
public class MyFriendFriendsListActivity extends BaseActivity {

    private static final String TAG = "MyFriendFriendsListActivity";
    private Context mContext;
    private ImageView title_back;//返回
    private WebView my_friend_friends_list_webview;//我的好友的好友的列表
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_friend_friends_list);
    ...
    private void findViews() {
        ...
        my_friend_friends_list_webview  = (WebView) findViewById(R.id.my_friend_friends_list_webview);
    ...
    private void webviewSetting(String html) {
        ...
        my_friend_friends_list_webview.loadData(html, "text/html;charset=UTF-8", null);
        //goods_list_webview.loadDataWithBaseURL("http://172.25.217.2:8080/WebRoot1/", html, "text/html", "HTF-8",null);

        my_friend_friends_list_webview.setWebChromeClient(new MyWebChromeClient());

        my_friend_friends_list_webview.setWebViewClient(new MyWebViewClient());

        //设置支持js
        WebSettings webViewSettings = my_friend_friends_list_webview.getSettings();
        webViewSettings.setJavaScriptEnabled(true);

        my_friend_friends_list_webview.addJavascriptInterface(new AccountInfoJs(mContext), "callClient");
