...
import com.sales.vo.GetMyCashResp;
...
public class SalesMsgUtils {
	...
	public static SalesBaseMsg CreateRequestMsg(String msgtype)
	{
		...
		if(MSG_TYPES.MSG_GET_ADDRESS_LIST.equals(msgtype)){
			return new GetAddressListReq();
		}

		if (MSG_TYPES.MSG_MODIFY_ADDRESS_INFO.equals(msgtype))
			return new ModifyAddressInfoReq();
		if (MSG_TYPES.MSG_PRE_LOGIN.equals(msgtype))
			return new PreLoginReq();
		if (MSG_TYPES.MSG_POST_LOGIN.equals(msgtype))
			return new PostLoginReq();
		if (MSG_TYPES.MSG_SHARE.equals(msgtype))
			return new ShareReq();

		if (MSG_TYPES.MSG_GET_MY_CASH.equals(msgtype))
			return new GetMyCashReq();
		if (MSG_TYPES.MSG_APP_VERSION.equals(msgtype))
			return new AppVersionReq();
		return null;
	}
	...
	public static SalesBaseMsg CreateRespMsg(String msgtype)
	{
		...
		if(MSG_TYPES.MSG_GET_ADDRESS_LIST.equals(msgtype)){
			return new GetAddressListResp();
		}
		if (MSG_TYPES.MSG_GET_MY_CASH.equals(msgtype))
			return new GetMyCashResp();
		if (MSG_TYPES.MSG_APP_VERSION.equals(msgtype))
			return new AppVersionResp();
		if (MSG_TYPES.MSG_PRE_LOGIN.equals(msgtype))
			return new PreLoginResp();
		if (MSG_TYPES.MSG_POST_LOGIN.equals(msgtype))
			return new PostLoginResp();
		return null;
	}
